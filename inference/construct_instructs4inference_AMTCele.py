...
def construct_instructs_VregVocEc(dim_name, num_examples, aff_name, data_name, Task_prompt, input_path, output_path):
    biz_data = torch.load(
        input_path + "./retrieval/data4RAG/%s/%s/%s/biz-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    tech_data = torch.load(
        input_path + "./retrieval/data4RAG/%s/%s/%s/tech-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    edu_data = torch.load(
        input_path + "./retrieval/data4RAG/%s/%s/%s/edu-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    entmt_data = torch.load(
        input_path + "./retrieval/data4RAG/%s/%s/%s/entmt-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    polit_data = torch.load(
        input_path + "./retrieval/data4RAG/%s/%s/%s/polit-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    sports_data = torch.load(
        input_path + "./retrieval/data4RAG/%s/%s/%s/sports-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    celebrity_data = torch.load(
        input_path + "./retrieval/data4RAG/%s/%s/%s/celebirty-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
...
def construct_instructs_VregVocEc_addexpl(dim_name, num_examples, aff_name, data_name, Task_prompt, input_path, output_path):
    ...
    biz_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/biz-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    tech_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/tech-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    edu_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/edu-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    entmt_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/entmt-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    polit_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/polit-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    sports_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/sports-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
    celebrity_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/celebirty-Retribasedon-%s.pth" % (data_name, aff_name, dim_name, aff_name))
...
def construct_instructs_EIregEIoc(dim_name, num_examples, aff_name, data_name, Task_prompt, input_path, output_path):
    ...
    biz_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/biz-Retribasedon-%s.pth" % (
    data_name, aff_name + "/" + emotion_name, dim_name, aff_name + "-" + emotion_name))
    tech_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/tech-Retribasedon-%s.pth" % (
    data_name, aff_name + "/" + emotion_name, dim_name, aff_name + "-" + emotion_name))
    edu_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/edu-Retribasedon-%s.pth" % (
    data_name, aff_name + "/" + emotion_name, dim_name, aff_name + "-" + emotion_name))
    entmt_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/entmt-Retribasedon-%s.pth" % (
    data_name, aff_name + "/" + emotion_name, dim_name, aff_name + "-" + emotion_name))
    polit_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/polit-Retribasedon-%s.pth" % (
    data_name, aff_name + "/" + emotion_name, dim_name, aff_name + "-" + emotion_name))
    sports_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/sports-Retribasedon-%s.pth" % (
    data_name, aff_name + "/" + emotion_name, dim_name, aff_name + "-" + emotion_name))
    celebrity_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/celebirty-Retribasedon-%s.pth" % (
    data_name, aff_name + "/" + emotion_name, dim_name, aff_name + "-" + emotion_name))
...
def construct_instructs_EIregEIoc_addexpl(dim_name, num_examples, aff_name, data_name, Task_prompt, input_path, output_path):
    ...
    biz_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/biz-Retribasedon-%s.pth" % (data_name, aff_name+"/"+emotion_name, dim_name, aff_name+"-"+emotion_name))
    tech_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/tech-Retribasedon-%s.pth"% (data_name, aff_name+"/"+emotion_name, dim_name, aff_name+"-"+emotion_name))
    edu_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/edu-Retribasedon-%s.pth"% (data_name, aff_name+"/"+emotion_name, dim_name, aff_name+"-"+emotion_name))
    entmt_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/entmt-Retribasedon-%s.pth"% (data_name, aff_name+"/"+emotion_name, dim_name, aff_name+"-"+emotion_name))
    polit_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/polit-Retribasedon-%s.pth"% (data_name, aff_name+"/"+emotion_name, dim_name, aff_name+"-"+emotion_name))
    sports_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/sports-Retribasedon-%s.pth"% (data_name, aff_name+"/"+emotion_name, dim_name, aff_name+"-"+emotion_name))
    celebrity_data = torch.load(input_path + "./retrieval/data4RAG/%s/%s/%s/celebirty-Retribasedon-%s.pth"% (data_name, aff_name+"/"+emotion_name, dim_name, aff_name+"-"+emotion_name))
...
if __name__ == "__main__":
    ...
    Task_prompt = "Task: Determine whether the target text is 0. fake or 1. legit. Please answer the question directly without explanation. You must provide a specific answer. "
    # test
    if args.aff_name == "Vreg" or args.aff_name == "Voc" or args.aff_name == "Ec":
        construct_instructs_VregVocEc(args.dim_name, args.num_examples, args.aff_name, data_name, Task_prompt,
                                      args.input_path, args.output_path)
        construct_instructs_VregVocEc_addexpl(args.dim_name, args.num_examples, args.aff_name, data_name, Task_prompt,
                                              args.input_path, args.output_path)
    else:
        construct_instructs_EIregEIoc(args.dim_name, args.num_examples, args.aff_name, data_name, Task_prompt,
                                      args.input_path, args.output_path)
        construct_instructs_EIregEIoc_addexpl(args.dim_name, args.num_examples, args.aff_name, data_name, Task_prompt,
                                              args.input_path, args.output_path)
